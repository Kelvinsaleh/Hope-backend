...
exports.shouldGenerateTitle = shouldGenerateTitle;
...
Title:`;
        ...
        logger_1.logger.info(`Generated chat title: "${title}"`);
        return title;
    }
    catch (error) {
        logger_1.logger.error("Failed to generate chat title:", error);
 ...
 */
function shouldGenerateTitle(messageCount, currentTitle) {
